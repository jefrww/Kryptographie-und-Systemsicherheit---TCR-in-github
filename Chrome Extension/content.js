...
const parentAddress = '0x1bA11f8083D1a501374c69003326ADd51dBDA8Df';
const childAbi = [
    {
        "inputs": [
            {
    ...
    chrome.storage.sync.get(['currentWallet'], function(result) {
        ...
        submitWithStake.addEventListener('click', function (){
            ...
            chrome.runtime.sendMessage({commentInfo: commentInfo}, function(response) {
                ...
                createComment(parentContract, wallet, String(response))
            });
        });
            ...
            getCommentFromParent(parentContract, commentId).then(function (result){
                ...
                if(result !== "0x0000000000000000000000000000000000000000"){
                    ...
                    upBtn.addEventListener('click', function () {
                        upvote(web3, childContract, wallet)
                    });
                    getTotalUp(childContract).then(function (result) {
                        upBtn.innerHTML = Web3.utils.fromWei(result, 'ether');
                    });
                    ...
                    downBtn.addEventListener('click', function () {
                        downvote(web3, childContract, wallet)
                    });
                    getTotalDown(childContract).then(function (result) {
                        downBtn.innerHTML = Web3.utils.fromWei(result, 'ether');
                    });
...
async function upvote(web3, contract, wallet) {
...
async function downvote(web3, contract, wallet) {
